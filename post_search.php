...
<html lang="th">
  <head>
    ...
    <title>ค้นหา: <?php echo $search_text ?> | NiceClean</title>
    <link
      rel="shortcut icon"
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        var search=<?php echo json_encode($search_text); ?>;
        $("#provincedata").load("post_search_text.php",{search_text: search});
        
        $("#province_dropdown").change(function(){
          var selected=$(this).val();
          $("#provincedata").load("post_search_text_province.php",{selected_province: selected, search_text: search});
        });
      });
    </script>
    ...
    <section class="pt-20 pb-10 lg:pt-[40px] lg:pb-20">
      <div class="container mx-auto">
        <div class="wow fadeInUp" data-wow-delay=".1s">
          <p class="text-4xl mb-4 font-semibold  text-black underline underline-offset-8">ค้นหา: <?php echo $search_text ?></p>
          <div>
