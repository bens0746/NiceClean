...
if($_GET['order_id']){
    ...
    SELECT users.user_id, users.img, users.verify, users.firstname, users.lastname, users.email, users.phone, users.lineID, post.post_id, post.title, post.img_title, package.package_name,package.package_price, orders.order_id, orders.order_start, orders.order_end, orders.message, orders.confirm, orders.status, orders.lat, orders.lng
    ...
    <div class="bg-white sm:max-w-full max-w-md rounded overflow-hidden shadow-lg">
        ...
        <?php
            ...
            <?php
                ...
                SELECT order_start_new, message_new, shift_id
        ...
        <?php
            ...
            <div class="px-6 py-4 text-center flex flex-wrap justify-center">
                    <a href="order_edit.php?order_id=<?php echo $_GET['order_id']?>" target="_blank" class="border rounded py-2 px-4 mx-1 text-lg font-semibold bg-yellow-400 text-white">
                    แก้ไขออเดอร์
                    </a>
        ...
        <?php } elseif ($row['confirm']== 1 and $row['status']== 0){?>
            ...
            <div class="px-6 py-4 text-center flex flex-wrap justify-center">
                <a href="#" class="border rounded py-2 px-4 mx-1 text-lg font-semibold bg-yellow-400 text-white">
                กำลังดำเนินการ
                </a>
            </div>
            <!-- ให้คะแนน -->
        <?php } elseif ($row['confirm']== 2 and $row['status']== 1){?>
            ...
            <div class="px-6 py-4 text-center flex flex-wrap justify-center">
                <a href="review.php?order_id=<?php echo $row['order_id']?>" target="_blank" class="border rounded py-2 px-4 mx-1 text-lg font-semibold bg-green-400 text-white">
                ให้คะแนนความพึงพอใจ
                </a>
